...
- **[Anthropic Claude](https://www.anthropic.com/)** - AI per estrazione ricette
- **[Tailwind CSS](https://tailwindcss.com/)** - CSS framework
- **Academia.tv** - Ispirazione per il formato ricette
...
_Gli screenshot saranno aggiunti dopo il completamento della Phase 1_
